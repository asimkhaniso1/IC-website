...
type Health = { configured: boolean; username: string };
    ...
    <div className="flex flex-wrap items-center justify-between gap-3">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-slate-600">{ready ? `Ready for QuickBooks username ${health?.username}.` : 'Set the server credentials before importing the QWC file.'}</p>
        </div>
      </div>
