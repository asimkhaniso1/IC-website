...
const groups: NavGroup[] = [
  { label: 'Customers & sales', icon: Users, items: [
    ['/factory/quotations', 'Quotations', FileCheck2], ['/factory/samples', 'Sample development', PackageCheck], ['/factory/samples/costing', 'Sample costing', ClipboardList], ['/factory/orders', 'Customer orders', ClipboardList],
  ]},
