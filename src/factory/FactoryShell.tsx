...
export default function FactoryShell({ children }: { children: ReactNode }) {
  ...
  const nav = [{ to: '/factory', label: 'Home', icon: Home }, { to: '/factory/production', label: 'Production', icon: Factory }, { to: '/factory/qc', label: 'Quality control', icon: ShieldCheck }, { to: '/factory/packing', label: 'Packing & finished', icon: PackageCheck }, { to: '/factory/dispatch', label: 'Dispatch', icon: Send }, { to: '/factory/traceability', label: 'Traceability', icon: Route }, { to: '/factory/grn', label: 'Goods receiving', icon: Truck }, { to: '/factory/purchase-requests', label: 'Purchase requests', icon: ShoppingCart }, { to: '/factory/gate-pass', label: 'Gate pass', icon: FileCheck2 }, { to: '/factory/stock', label: 'Stock ledger', icon: PackageOpen }, { to: '/factory/stock/register', label: 'Stock register', icon: ClipboardList }, { to: '/factory/reports', label: 'Reports', icon: BarChart3 }, { to: '/factory/audit', label: 'Audit log', icon: History }, { to: '/factory/setup', label: 'Setup', icon: Settings2 }];
