...
export default function FactoryShell({ children }: { children: ReactNode }) {
  ...
  const nav = [{ to: '/factory', label: 'Home', icon: Home }, { to: '/factory/overview', label: 'Dashboard', icon: BarChart3 }, { to: '/factory/orders', label: 'Orders', icon: ClipboardList }, { to: '/factory/machines', label: 'Machines', icon: Factory }, { to: '/factory/production', label: 'Production', icon: ClipboardList }, { to: '/factory/qc', label: 'Quality control', icon: ShieldCheck }, { to: '/factory/packing', label: 'Packing & finished', icon: PackageCheck }, { to: '/factory/dispatch', label: 'Dispatch', icon: Send }, { to: '/factory/traceability', label: 'Traceability', icon: Route }, { to: '/factory/grn', label: 'Goods receiving', icon: Truck }, { to: '/factory/purchase-requests', label: 'Purchase requests', icon: ShoppingCart }, { to: '/factory/purchase-orders', label: 'Purchase orders', icon: ClipboardList }, { to: '/factory/gate-pass', label: 'Gate pass', icon: FileCheck2 }, { to: '/factory/stock', label: 'Stock ledger', icon: PackageOpen }, { to: '/factory/stock/register', label: 'Stock register', icon: ClipboardList }, { to: '/factory/stock/adjustments', label: 'Stock adjustments', icon: Settings2 }, { to: '/factory/stock/transfers', label: 'Stock transfers', icon: Route }, { to: '/factory/stock/take', label: 'Stock take', icon: ClipboardList }, { to: '/factory/reports', label: 'Reports', icon: BarChart3 }, { to: '/factory/audit', label: 'Audit log', icon: History }, { to: '/factory/setup', label: 'Setup', icon: Settings2 }];
